                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                        {(post.type === 'event' || post.date) && (
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg shrink-0 border border-blue-100 dark:border-blue-900/30">
                                    <Calendar className="w-5 h-5 text-[#002147] dark:text-blue-400" />
                                </div>
                                <div>
                        ...
                        {(post.type === 'event' || post.time) && (
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg shrink-0 border border-blue-100 dark:border-blue-900/30">
                                    <Clock className="w-5 h-5 text-[#002147] dark:text-blue-400" />
                                </div>
                                <div>
                        ...
                        {(post.type === 'event' || post.location) && (
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg shrink-0 border border-blue-100 dark:border-blue-900/30">
                                    <MapPin className="w-5 h-5 text-[#002147] dark:text-blue-400" />
                                </div>
                                <div>
                    ...
                    {post.eventWhatsappLink && (
                        <div className="mb-6">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold transition-all transform hover:scale-[1.02] shadow-md border-b-4 border-green-800"
                            >
                    ...
                    {post.type === 'announcement' && post.relatedEventId && post.relatedEventTitle && onNavigateToPost && (
                        <div className="mb-6">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#002147] hover:bg-[#00152e] text-white rounded-xl font-bold transition-all transform hover:scale-[1.02] shadow-md border border-[#00152e]"
                            >
