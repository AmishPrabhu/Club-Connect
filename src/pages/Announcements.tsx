        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 py-6 md:py-12">
            ...
            <div className="mb-6 md:mb-8">
                ...
                <div className="flex items-center gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-14 md:h-14 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl md:rounded-2xl flex items-center justify-center">
                        <Megaphone className="w-5 h-5 md:w-7 md:h-7 text-white" />
                    </div>
                    <div>
                        <h1 className="text-xl md:text-3xl font-bold text-slate-900 dark:text-white">Announcements</h1>
                        <p className="text-xs md:text-base text-slate-600 dark:text-slate-400">Latest updates from clubs</p>
                    </div>
                </div>
            </div>

            {/* Filters */}
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-3 md:p-4 mb-6 md:mb-8">
                <div className="flex flex-wrap items-center gap-2 md:gap-4">
                    <div className="flex items-center gap-2">
                        <Filter className="w-4 h-4 text-slate-500" />
                        <span className="text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300">Filter:</span>
                    </div>
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white text-xs md:text-sm font-medium px-3 md:px-4 py-1.5 md:py-2 pr-8 md:pr-10 rounded-lg border border-slate-200 dark:border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                        >
                        ...
                        <ChevronDown className="w-4 h-4 text-slate-500 absolute right-2 md:right-3 top-1/2 -translate-y-1/2 pointer-events-none" />
                    </div>

                    {/* Results count */}
                    <div className="ml-auto text-xs md:text-sm text-slate-500 dark:text-slate-400">
                        {visiblePosts.length} of {filteredPosts.length}
                    </div>
                </div>
            </div>
                                    ...
                                    <div className="sm:w-3/4 p-6 flex flex-col justify-center">
                                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                            <div className="flex-1">
                                                <h3 className="text-base md:text-xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors line-clamp-1">
                                                    {post.title}
                                                </h3>
