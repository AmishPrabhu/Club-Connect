...
export default function BulkImportModal({ isOpen, onClose, clubId, clubName, onSuccess }: BulkImportModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white/85 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700">
                {/* Header */}
