      ...
      <header className="glass-header shadow-sm">
        <div className="max-w-[1400px] mx-auto px-3 md:px-6 h-14 md:h-[4.5rem] flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="md:hidden">
                <span className="text-base font-serif font-bold tracking-tight text-slate-900 dark:text-white">
                  WCE, Sangli
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button
              onClick={startTour}
              className="hidden xl:flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-300 dark:border-slate-600 bg-slate-100/50 dark:bg-slate-800/50 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-slate-700/50 text-xs font-semibold transition-all"
            >
            ...
            <button
              ...
              className="p-1.5 md:p-2 rounded-full text-slate-500 dark:text-slate-400 hover:bg-black/5 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white transition-colors"
            ...
            <button
              ...
              className="p-1.5 md:p-2 rounded-full text-slate-500 dark:text-slate-400 hover:bg-black/5 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white transition-colors relative"
              id="tour-notifications"
            >
              <Bell className="w-4 h-4 md:w-5 md:h-5" />
              {unreadCount > 0 && (
                <span className="absolute top-1 right-1 md:top-1.5 md:right-1.5 w-1.5 h-1.5 md:w-2 md:h-2 bg-red-500 rounded-full border-2 border-white dark:border-slate-900"></span>
              )}
            </button>
            ...
            {user ? (
              ...
              <button
                ...
                className="ml-2 px-3 py-2 md:px-5 md:py-2.5 bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold rounded-full border border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500 transition-all text-sm flex items-center gap-2"
                id="tour-profile"
              >
          ...
          <div className="lg:hidden absolute top-[4.5rem] left-0 right-0 glass-header shadow-xl animate-in slide-in-from-top-2 duration-200">
            <div className="p-4 space-y-2">
              ...
              <button
                ...
                className="w-full text-left px-4 py-3 rounded-lg text-base font-bold text-slate-500 dark:text-slate-400 hover:bg-black/5 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white transition-all flex items-center gap-2"
              >
